...
public class NavigateBar extends Bar {
	...
	public void setImageLeft(int resId, View.OnClickListener listener)
	{
		if(mIvLeft != null)
		{
	...
	public void setImageRight(int resId, View.OnClickListener listener)
	{
		if(mIvRight != null)
		{
	...
	public void notifyBarSetChanged() {
		...
		BarMenuContainer menu = getBarMenu();
