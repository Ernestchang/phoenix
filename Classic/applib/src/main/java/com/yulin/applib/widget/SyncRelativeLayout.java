 ...
 * @version 1.0.0
 */
public class SyncRelativeLayout extends RelativeLayout implements
		EnhancedScrollView.OnScrollChangedListener {
	...
	public final static String SyncRelativeLayout_holderView = "syncrelativelayout_holderview";
	public final static String SyncRelativeLayout_syncView = "syncrelativelayout_syncview";
	 ...
	 *            Style.
	 */
	public SyncRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 *            Some attrs.
	 */
	public SyncRelativeLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}
...
//		mGravity = a.getInt(R.styleable.SynchronizedRelativeLayout_syncView_gravity, mGravity);
		...
		mPlaceholderViewId = getContext().getResources().getIdentifier(SyncRelativeLayout_holderView, "id", getContext().getPackageName());
		if (mPlaceholderViewId == 0) {
			e = new IllegalArgumentException("Please set view with id:"+SyncRelativeLayout_holderView);
		}
		mSynchronizedViewId = getContext().getResources().getIdentifier(SyncRelativeLayout_syncView, "id", getContext().getPackageName());
		if (mSynchronizedViewId == 0) {
			e = new IllegalArgumentException("Please set view with id:"+SyncRelativeLayout_syncView);
		}
...
//			mSynchronizedView.setLayoutParams(mSynchronizedParams);
			...
			// correct number.
//			RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.FILL_PARENT, 1000);
//			params.addRule(RelativeLayout.ALIGN_PARENT_TOP);
//			mSynchronizedView.setLayoutParams(params);
