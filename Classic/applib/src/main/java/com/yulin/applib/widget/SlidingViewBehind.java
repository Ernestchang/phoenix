...
public class SlidingViewBehind extends ViewGroup {

	private static final String TAG = "SlidingViewBehind";

	private static final int MARGIN_THRESHOLD = 48; // dips
	private int mTouchMode = SlidingMenu.TOUCHMODE_MARGIN;

	private SlidingViewAbove mViewAbove;
	...
	public SlidingViewBehind(Context context) {
		this(context, null);
	}

	public SlidingViewBehind(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setCustomViewAbove(SlidingViewAbove customViewAbove) {
	...
	public void setSelectedView(View v) {
		if (mSelectedView != null) {
			mSelectedView.setTag(mSelectedViewKey, null);
			mSelectedView = null;
		}
		if (v != null && v.getParent() != null) {
			mSelectedView = v;
			mSelectedView.setTag(mSelectedViewKey, TAG+"SelectedView");
			invalidate();
		}
	}
