 ...
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file kt in
...
import com.yulin.applib.BuildConfig;
...
public class PinnedSectionListView extends ListView {
    ...
    private final OnScrollListener mOnScrollListener = new OnScrollListener() {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            if (mScrollListener != null) {
                mScrollListener.postScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
            }
        };
    ...
    private PostScrollListener mScrollListener;
